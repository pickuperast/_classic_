...
function private.GetInboxMailsFrame()
	...
	local frame = TSMAPI_FOUR.UI.NewElement("Frame", "inbox")
		...
		:AddChild(TSMAPI_FOUR.UI.NewNamedElement("ActionButton", "openAllMail", "TSMMailOpenAllBtn")
			:SetStyle("font", TSM.UI.Fonts.MontserratMedium)
		...
		:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "buttons")
			:SetLayout("HORIZONTAL")
			:AddChild(TSMAPI_FOUR.UI.NewNamedElement("ActionButton", "openAllSales", "TSMMailOpenSalesBtn")
				:SetStyle("font", TSM.UI.Fonts.MontserratRegular)
				:SetStyle("margin.right", 8)
				:SetStyle("height", 20)
				:SetStyle("fontHeight", 12)
			...
			:AddChild(TSMAPI_FOUR.UI.NewNamedElement("ActionButton", "openAllExpires", "TSMMailOpenExpiresBtn")
				:SetStyle("font", TSM.UI.Fonts.MontserratRegular)
				:SetStyle("height", 20)
				:SetStyle("fontHeight", 12)
