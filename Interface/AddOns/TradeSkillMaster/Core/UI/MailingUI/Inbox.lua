	...
	if TSM.IsWowClassic() then
		frame:AddChild(UIElements.New("Frame", "bottom")
			...
			:AddChild(UIElements.New("Frame", "buttons")
				...
				:SetHeight(24)
				:SetMargin(0, 0, 8, 0)
				:AddChild(UIElements.NewNamed("ActionButton", "openAllSales", "TSMMailOpenSalesBtn")
					:SetMargin(0, 8, 0, 0)
					:SetFont("BODY_BODY2")
					:SetText(L["Sold"])
					:SetContext("SALE")
		...
		frame:AddChild(UIElements.New("Frame", "bottom")
			...
			:SetPadding(8)
			:SetBackgroundColor("PRIMARY_BG_ALT")
			:AddChild(UIElements.NewNamed("ActionButton", "openAllMail", "TSMMailOpenAllBtn")
				:SetHeight(26)
			...
			:AddChild(UIElements.New("Frame", "buttons")
				...
				:AddChild(UIElements.NewNamed("ActionButton", "openAllExpires", "TSMMailOpenExpiresBtn")
					:SetMargin(0, 8, 0, 0)
					:SetFont("BODY_BODY2")
