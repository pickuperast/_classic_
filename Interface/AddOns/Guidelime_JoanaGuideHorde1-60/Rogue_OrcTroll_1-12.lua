...
06) Make sure "Cutting Teeth [QC788-]" is complete, then go to The Den entrance and turn in "Cutting Teeth [QT788-]" and "Sarkoth [QT804-]" (42.68, #2 on map), accept "Sting of the Scorpid [QA789-]" and "Encrypted Tablet/Parchment [QA3083-]" .
07) Go half way into the cave and from the Rogue Trainer (41.68) turn in "Encrypted Tablet/Parchment [QT3083-]" .  Also get new spells/abilities from your class trainer.
...
14) Outside by the wagon, turn in "Vile Familiars [QT792-]" (43.69, #8 on map), accept "Burning Blade Medallion [QA794-]".  Also make sure you get new spells/abilities. The Rogue Trainer (is at 41.68 half way into the cave).
...
14) If you're not at least 3 bars away from lvl 8, grind until you are (for lvl 8 spells/abilities), Then go to Razor Hill and at the top of the burrow turn in "From The Wreckage.... [QT825-]" (52.44, #4 on map).    Also get new spells/abilities from the Rogue Trainer at the top of the burrow.  Also make sure you are repaired/resupplied.
...
Rogue, 17a) Next to you at the top of the burrow, accept your level 10 class quest "Therzok [QA1859-]".  Also get new spells/abilities.
Rogue, 17b) Go north to Enter Orgrimmar.


Orgrimmar
Rogue, 1a) As you enter Orgrimmar, hug the west path and go up the spiral ramp (entrance at 42.62).
Rogue, 1b) Enter Cleft of Shadow (entrance at 40.54).
Rogue, 1c) As you enter Cleft of Shadow make a sharp left into the first hut and turn in "Therzok [QT1859-]" (43.53), accept "The Shattered Hand [QA1963-]".
...
07) Hearth to Razor Hill.  Make sure you are level 12 (grind on any mobs until you are).  Make sure you get repaired/resupplied.  Upgrade First Aid in the Barracks from Rawrk to learn Heavy Linen Bandage.  Also get new spells/abilities from the Rogue Trainer at the top of the burrow.
Rogue, 7a) On the west side in Razor Hill, accept "Conscript of the Horde [QA840-]" (51.44).
...
02) Next to you at the watchtower, turn in (if you have it from the Durotar section) "Ak'Zeloth [QT809-]" (62.20), accept "The Demon Seed [QA924-]".  Then loot a Flawed Power Stone from the table next to you.  NOTE: The Flawed Power Stone item received only lasts 30 minutes, so you need to do the next few steps somewhat quickly.
03) Do "The Shattered Hand [QC1963-]".  Run directly south along the river to Ratchet (avoid mobs and hurry so your Flawed Power Stone maintains time).  Once at Ratchet don't stop to pick up quests, continue south through Ratchet and follow the narrow path by the coastline to The Merchant Coast.  You will then see a slope going upwards on your right with a fence running up it (around 63.44).  Work your way up this slope until you run into Tazan and kill/loot this troll.  He patrols from the middle of the slope to the top camp.
04) Die on purpose and res at spirit.
05) Follow the main path NW to Crossroads and at Sergra Darkthorn, turn in "Crossroads Conscription [QT842-]" (52.31), accept "Plainstrider Menace [QA844-]".
06) NE in XRs, accept "Meats to Orgrimmar [QA6365-]" (53.30).
...
08) Once you get at the top do "The Demon Seed [QC924-]": go in the small cave and use your Flawed Power Stone quest item on The Altar of Fire (48.19).  NOTES:  Watch out for a rare elite named Rathorian, he is very dangerous.  If he is in the way, then either try to team up with someone to help you kill him, or this quest can be skipped.  His respawn is every 5.5 hours.
09) Die on purpose and res at spirit to get back to XRs.
10) South in XRs accept "The Forgotten Pools [QA870-]" (52.32).  Then next to you, get repaired/resupplied from the Clothier.
11) Go in the Inn and make XRs your new home (52.30).
12) Right outside the Inn on your right accept "Raptor Thieves [QA869-]" (52.30).
13) At the orc standing at the bottom of the watchtower accept "Disrupt the Attacks [QA871-]" (52.31), and "Supplies for the Crossroads [QA5041-]".
14) Go up the watchtower next to you and accept "Harpy Raiders [QA867-]".
15) Drop down, go to the Wind Rider Master and turn in "Meats to Orgrimmar [QT6365-]", accept "Ride to Orgrimmar [QA6384-]".  And right next to the Wind Rider Master accept "Fungal Spores [QA848-]" and "Wharfmaster Dizzywig [QA1492-]"
16) At the Wind Rider Master, fly to Orgrimmar, Durotar.


01) When you land at Orgrimmar, stay up and go across the wood bridge and then enter the the Cleft of Shadow (40.53 in Orgrimmar)...
02) As you enter Cleft of Shadow make a sharp left into the first hut and turn in "The Shattered Hand [QT1963-]" (43.53), accept the next part [QA1858-].
03) Go to the Inn and turn in "Ride to Orgrimmar [QT6384-]" (54.68), accept "Doras the Wind Rider Master [QA6385-]".
04) Next to you do "The Shattered Hand [QC1858-]": use your Pick Pocket ability on the Tauren Gamon in the Inn to loot Tazan's Key.  Then use this key (found in your Keyring) on Tazan's Satchel quest item in your inventory.
05) Follow the west path and then go up the ramp in the building (at 42.62), to go up.
06) Enter the the Cleft of Shadow (40.53, #1 on map)...
07) As you enter Cleft of Shadow make a sharp left into the first hut and turn in "The Shattered Hand [QT1858-]" (43.53, #2 on map).
08) Go back up to the Wind Rider Master (45.64) and turn in "Doras the Wind Rider Master [QT6385-]", accept "Return to the Crossroads. [QA6386-]".  Then take a flight to Crossroads, The Barrens.
09) NE in Crossroads turn in "Return to the Crossroads. [QT6386-]" (53.30).
...
11) Go east and do "Disrupt the Attacks [QC871-]": kill the Razormane mobs (all around 54.27).  NOTE: Back in the Razormane camp there is a barrel called "Chen's Empty Keg [QA3238-]" (56.27), loot it and accept the quest from the item received.
12) Go back to XRs and turn in (if it's complete) "Plainstrider Menace [QT844-]" (from Sergra Darkthorn 52.31), accept "The Zhevra [QA845-]".
13) At the orc standing at the bottom of the watchtower, turn in "Disrupt the Attacks [QT871-]" (52.30), accept "The Disruption Ends [QA872-]".  Make sure you are repaired/resupplied.
]], "Dreamcast1991")