...
04) Once done, go back to the church (31.66, #2 on map) and turn in "The Mindless Ones [QT364-]".  Accept "Glyphic Scroll [QA3098-]" and "Rattling the Rattlecages [QA3901-]".  Next to you accept "The Damned [QA376-]".
05) Next to you in the church, from the Mage Trainer, turn in "Glyphic Scroll [QT3098-]". Also get new spells/abilities.
...
07) Go back to the church and turn in "Rattling the Rattlecages [QT3901-]" (31.66, #2 on map).  Next to you, turn in "The Damned [QT376-]".  Accept "Marla's Last Wish [QA6395-]".  Next to you in the church, from the Mage Trainer, get your level 4 spells/abilities.
...
09) In Brill's Inn, get your level 6 spells/abilities.  The Mage Trainer is right at the top of the stairs.
...
09) Make sure you are repaired/resupplied.  Also get your level 8 spells/abilities.  The Mage Trainer is right at the top of the stairs in the Inn.
...
Mage Level 10 Quest
01) Go upstairs in Brill's Inn and from the Mage Trainer just at the top of the stairs, accept "Speak with Anastasia [QA1881-]" (62.52).  Also learn your level 10 spells/abilities.
02) Then go down into the Under City (UC). (entrance at 63.74 in Tirisfal Glades)
03) Once in the UC, go up to the Innkeeper (68.38) and make Undercity your new home.
04) Go NE to Magic Quarter, turn in "The Prodigal Lich [QT405-]" (up at 84.17), SKIP "The Lich's Identity".
05) Go NE a bit more in The Magic Quarter and turn in "Speak with Anastasia [QT1881-]" (85.10), accept "The Balnir Farmstead [QA1882-]".
06) While in the UC, you can learn new weapon possibilities at the Weapons Master (57.33), if you can afford to do so.
07) Exit the UC through the sewer (entrance west in UC, 46.44).
08) As you exit the sewer, go down to the tower and do "At War with the Scarlet Crusade [QC427-]": kill the needed mobs and Captain Perrine is in the watchtower (51.68 in Tirisfal Glades).  NOTE:  "Proof of Demise" does not need to be completed now.
...
04) Go east to Balnir Farmstead (around 76.61) and do "Rear Guard Patrol [QC356-]" along with your class quest "The Balnir Farmstead [QC1882-]": kill the zombies and spirits around the farm and go SE in the farm to loot a Balnir Snapdragons in the garden (77.62).
...
07) Hearth to Undercity.
Mage, 7a) Go NE to The Magic Quarter and turn in "The Balnir Farmstead [QT1882-]" (85.10).
Mage, 7b) Exit the UC and NE at the small camp along the main path, turn in "Rear Guard Patrol [QT356-]" (66.60, #3 on map).
Mage, 7c) Go NW to Brill and then go upstairs in the Inn and turn in (if you haven't yet) "The Chill of Death [QT375-]" (62.53, #1 on map).
...
09) Make sure you are level 12, grind on any mobs around Brill until you are.  Then go in Brill's Inn and get your level 12 spells/abilities.  The Mage Trainer is right at the top of the stairs in the Inn.
...
Mage, 4a) Go to the Magic Quarter (85.15) to get your level 14 spells/abilities.
...
10) Leave Orgrimmar (south) and run to Razor Hill (in Durotar) to get new spells/abilities.  You can also upgrade First Aid if you need to in the Barracks from the First Aid Trainer (54.42).  Mages, ignore getting your abilities as you already did that at the UC!
