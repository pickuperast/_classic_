...
04) Once done, go back to the church (31.66, #2 on map) and turn in "The Mindless Ones [QT364-]".  Accept "Hallowed Scroll [QA3097-]" and "Rattling the Rattlecages [QA3901-]".  Next to you accept "The Damned [QA376-]".
05) Next to you in the church, from the Priest Trainer, turn in "Hallowed Scroll [QT3097-]". Also get new spells/abilities.
...
07) Go back to the church and turn in "Rattling the Rattlecages [QT3901-]" (31.66, #2 on map).  Next to you, turn in "The Damned [QT376-]".  Accept "Marla's Last Wish [QA6395-]".  Next to you in the church, from the Priest Trainer get your level 4 spells/abilities. 
...
18) Back west, turn in "The Red Messenger [QT382-]" (32.66), accept "Vital Intelligence [QA383-]".  In the church, accept "In Favor of Darkness [QA5651-]".  Make sure you are repaired/resupplied.
...
09) In Brill's Inn, get your level 6 spells/abilities.  The Priest Trainer is upstairs.  Also from your trainer, turn in "In Favor of Darkness [QT5651-]", accept "Garments of Darkness [QA5650-]".
...
Priest, 12a) At the north graveyard gate entrance (59.46) do "Garments of Darkness [QC5650-]": use Lesser Heal (R2) and Power Word: Fortitude on Deathguard Kel /target kneeling down.
...
01) Grind back to Brill and in the Inn, accept "Deaths in the Family [QA354-]" and "The Haunted Mills [QA362-]" (62.52).  And go upstairs in the Inn and accept "The Chill of Death [QA375-]".  Also, upstairs at the Priest Trainer, turn in "Garments of Darkness [QT5650-]".
...
09) Make sure you are repaired/resupplied.  Also get your level 8 spells/abilities.  The Priest Trainer is upstairs in the Inn.
...
01) Go upstairs in Brill's Inn and accept (if it's available) "Touch of Weakness [QA5659-]" (62.52).  Also learn your level 10 spells/abilities.
02) Then go down into the Under City (UC). (entrance at 63.74 in Tirisfal Glades)
03) While in the UC, you can learn new weapon possibilities at the Weapons Master (57.33), if you can afford to do so.
04) Go NW and up in the War Quarter, turn in (if you have it) "Touch of Weakness [QT5659-]" (49.17).  You now have Touch of Weakness (R1)!  CLASSIC WOW:  You will simply need to talk to your trainer to learn this new ability.
05) Exit the UC through the sewer (entrance west in UC, 46.44).
06) As you exit the sewer, go down to the tower and do "At War with the Scarlet Crusade [QC427-]": kill the needed mobs and Captain Perrine is in the watchtower (51.68 in Tirisfal Glades).  NOTE:  "Proof of Demise" does not need to be completed now.
...
09) Make sure you are level 12, grind on any mobs around Brill until you are.  Then go in Brill's Inn and get your level 12 spells/abilities.  The Priest Trainer is upstairs in the Inn.
...
10) Leave Orgrimmar (south) and run to Razor Hill (in Durotar) to get new spells/abilities.  You can also upgrade First Aid if you need to in the Barracks from the First Aid Trainer (54.42).  You can find the Priest Trainer in the Barracks (54.43).
