...
04) Go west to The War Quarter to the Weapon Master (57.32) and if you have extra gold to spare, feel free to learn all the weapons from him.  Hunters, you can upgrade your quiver to a Heavy Quiver (if your using one) at Benijah Fenner next to the Weapon Master at the middle of the weapon table.
...
Hunter, 11a) Note that you cannot buy bullets in Hinterlands (only arrows).  You can get bullets from the General Goods vendor just outside of the Inn at Tarren Mill. and (if you need them) make sure you are stocked up as you will need a lot for the Hinterlands grind coming up!
...
01) Once in Grom'gol, turn in "Grim Message [QT2932-]" (32.28).  Hunters, get new spells/abilities at the Hunter Trainer (31.29).  The Pet Trainer is next to you as well.
...
07) Up in the building (48.55), turn in "The Disgraced One [QT2621-]", accept "The Missing Orders [QA2622-]".  And turn in "Return to Fel'Zerul [QT1444-]", SKIP "The Temple of Atal'Hakkar" (Dungeon).
08) In the Inn turn in "The Missing Orders [QT2622-]" (45.57, #1 on map), accept "The Swamp Talkerr [QA2623-]".  Hunters, get new spells/abilities at the Hunter Trainer at Stonard (47.53).
...
Hunter, 2a) Hunters, right next to the Witch Doctor, stable your pet at the Stable Master.
03) Hunters, go west and tame an Ironfur Patriarch (for Claw R7).  Try to get a level 49.  Then use this pet to do the following quests: 
...
Hunter, 8a) Hunters, abandon your bear and get your cat back out from the Stable Master (next to the Witch Doctor) and teach him Claw 7.
...
06) North at Steamwheedle Port turn in "Screecher Spirits [QT3520-]" (67.22), SKIP "The Prophecy of Mosh'aru" (Zul'Farrak Dungeon).  Hunters, stock up on arrows (if your using them), because you cannot buy them at Gadgetzan.  You can get them from Jabbey in the hut (67.22).
...
15) Get your level 50 spells/abilities.  Hunters, ignore this step as you will do this later!
