...
Thunder Bluff
01) Once in Thunder Bluff (TB), go to the weapon master (41.63) and get new weapon possibilities.  Hunters, I recommend learning Guns and (if you haven't yet) Staves.
...
04) Go to your class trainer to get new spells/abilities.  Hunters, I only recommend getting new abilities if you can easily afford them, this is generally what's available right now.  Hunter Trainers are on The Hunter's Rise (59.87).
...
03) Stay up and go NE, across the bridge to the Wind Rider Master (45.64) and get the FP.  Then fly to Ratchet, The Barrens.
...
03) Go to your class trainer to get new spells/abilities. The Hunter Trainers are on The Hunter Rise (59.87 in TB).  Don't forget to learn Growl R3 from the Pet Trainer.
04) Make sure "The Ashenvale Hunt [QA6382-]" is accepted from Bluff Runner Windstrider /target.  He patrols around TB, see patrol path (#1 on map).  PLEASE REPORT TO ME if "The Ashenvale Hunt [QA6382-]" quest is needed to be turned in first at Ashenvale in order to open the 3 quest items from the named mobs in Ashenvale.  You would do this by going to Ashenvale later at lvl 26 without getting this quest first!  Thanks!
05) Above The Spirit Rise, upgrade First Aid from the First Aid Trainer (30.21).  NOTE:  You need skill 80 for Wool Bandage and skill 115 for Heavy Wool Bandage.
06) Hearth back to XRs.
