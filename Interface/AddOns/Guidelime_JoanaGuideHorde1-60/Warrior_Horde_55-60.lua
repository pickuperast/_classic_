...
06) Go just NE a bit to the small Scarlet camp (41.52) and do "Scarlet Diversions [QC5096-]": clear the mobs in the area (you need to work quickly to avoid respawns) then click on the Command Tent to burn it and then use the Scourge Banner quest item at the camp. (See Video).  Warriors, carefully range pull a section around the tent and work your way close.  If you pull too many, fear them and reset.
...
02) Do "Augustus' Receipt Book [QC6164-]": go NE a bit to the Terrordale Inn (the largest building in the area) and go up in the Inn, make a right and between two split open barrels loot Augustus' Receipt Book on the ground.  NOTE:  Kill/loot all Crypt Fiends you see to start obtaining Crypt Fiend Parts (used for a later quest).  The Crypt Fiend grind is brutal to do solo for Warriors, unless you can find help I recommend skipping getting the 30 Crypt Fiend Parts along with the future steps associated with this.
...
Warrior, 1a) Warriors, the next few quests are very difficult to solo. They are possible, but very hard and the corpse run is very long. If you can't find help I would suggest skipping to step #7 below (and abandoning "Unfinished Business")..
...
-->  You can grind on Winterfall furblogs in Winterspring for Winterfall E'kos which can be turned in for Juju Power.  This will also gain you rep with Timbermaw.
