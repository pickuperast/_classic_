...
08) If you need to, get new spells/abilities.  Hunters, go get new spells/abilities.  Make sure you learn Growl R6 from the Pet Trainer.  Learning Fire Resistance for your pet comes useful for the Blood Elf grind coming later.  NOTE:  Do NOT accept "The Hunter's Charm" (yet).
...
Hunter, 3a) Hunters, stable your pet at the Stable Master (69.80).

Hunter, 3b) Go tame a Saltwater Snapjaw turtle along the shore above Revantusk Village (starting at 76.70, #4 on map), for Bite R7.

Hunter, 3c) Once you get Bite R7, abandon turtle and get your cat back out from the Stable Master (69.80) and teach him Bite R7.
...
08) Get new spells/abilities at your class trainer.  Hunters, go south to The Hunter Rise (59.87).  Also from your Hunter Trainer Kary Thunderhorn, accept "The Hunter's Charm [QA8151-]".
...
Hunter, 1a) Hunters, go east up at (42.43) and turn in "The Hunter's Charm [QT8151-]", accept "Courser Antlers [QA8153-]".
02) Go NE to the hill entrance (53.20)...
03) Go up to the top of the hill and accept "Kim'jael Indeed! [QA3601-]" (53.22).
Hunter, 3a) Hunters, start doing "Courser Antlers [QC8153-]": kill/loot Mosshoof Courser (deer) /target all around the open fields up north.  While working on this, you can also start working on the next step:
...
Hunter, 8a) Hunters, make sure "Courser Antlers [QC8153-]" is finished now: kill/loot Mosshoof Courser (deer) /target all around the open fields up north. (#3a on map)
Hunter, 8b) Go west up at (42.43, #1a on map) and turn in "Courser Antlers [QT8153-]", accept "Wavethrashing [QA8231-]".
...
Hunter, 2a) Hunters, grind all the way to the NE end of Azshara to the shore and do "Wavethrashing [QC8231-]": kill/loot Wavethrashers (of any type).  These mobs are found all along the shore line and some in the sea.
Hunter, 2b) Since you cannot buy Arrows/Bullets at Valormok, Azshara, and if you need more, hearth to Orgrimmar, restock on ammo, then fly back to Azshara.  NOTE:  In Orgrimmar, Bullets can be bought at (52.62) and Arrows can be bought at (48.81).
03) Go to Valormok and turn in "Betrayed [QT3506-]" (22.52), accept the next part [QA3507-].  Make sure you are repaired/resupplied.
Hunter, 3a) Grind your way back to (42.43) and turn in "Wavethrashing [QT8231-]", SKIP "The Green Drake" (Dungeon quest), but you may want to do this later with a group to get one of the rewards it gives.
...
06) If you need to, get new spells/abilities.  Hunter Trainers are just north at (66.19).  Although if you are all caught up with getting your previous spells/abilities then the only one that's somewhat worth getting for lvl 54 is Multi-Shot R4, so if you are in a hurry I recommend skipping it.  Make sure you are repaired/resupplied.
...
07) Go up to the Wind Rider Master and get the FP there (34.54).  Make sure you are repaired/resupplied.  Hunters, if you are using arrows, make sure you stock up on them as you will not be able to purchase any for a long time.
