...
11) "Rin'ji is Trapped! [QC2742-]": in the building and from Rin'Ji in the cage (#10 on map), accept the escort from him and then escort him out of  Quel'Danil Lodge.  TIP:  Clear out the path in front of the lodge first.  If you're alone, you might need to use Retaliation on the 3-pack before his cage.
...
10) Go east to the shore and attempt to do "The Captain's Chest [QC614-]" (Elite): kill/loot Gorlash /target.  This elite giant patrols up and down the shore (around 37.70).  You may need to group up with someone, if you cannot do it, it can be skipped/abandoned.  Warriors, this is near to impossible to solo, you would need help.
...
01) Do "Treant Muisek [QC3126-]": use the Treant Muisek Vessel quest item on Wandering Forest Walker /target corpses.  There is one (at 74.39) and another one (at 73.55).  You can just use these two spawn locations to get the 3 you need, wait for the first one to respawn again (grind on mobs while waiting).  You'll need to Hamstring kite them.
...
15) Get your level 50 spells/abilities. 
