...
01) Get the FP SE at Grom'Gol from the Wind Rider Master (33.29).  Make sure you are repaired/resupplied. 
...
07) Go east of the river and do "Panther Mastery [QC190-]": kill 10 Young Panthers (around 39.9).  Use the Hamstring Method if they are 2/3+ levels higher than you.
...
04) Get new spells/abilities.  Warriors, go next to you at the Hall of the Brave (80.32).  Recommended abilities to get are:  Heroic Strike R5, Berserker Rage, Execute R2, Battle Shout R4, Slam, Hamstring R2, and Shield Wall.
...
10) Go back west to Shadowprey Village and down at the docks turn in "Other Fish to Fry [QT6143-]" and next to you at the hut "Clam Bait [QT6142-]" (23.73).

11) Go to the Wind Rider Master (22.74) at the end of the docks at Shadowprey Village and fly to Camp Taurajo, The Barrens.  NOTE:  Consider flying to TB first to get new spells/abilities.  Warriors, the lvl 34 abilities are not worth much for PvE, so it is recommended to skip them.
...
07) Go to the Bank (63.37) and get the following items out: Bloody Bone Necklaces, Kravel's Parts Order, Kravel's Crate and Silk Cloth (to build up First Aid).  Put in the bank:  Belgrom's Sealed Note and any water breathing potions.
...
08) Go east and do "Panther Mastery [QC192-]" along with "Mok'thardin's Enchantment [QC570-]": kill/loot Shadowmaw Panthers /target (around 49.23).  Also kill/loot Stranglethorn Tigress around the same area for the fang. 
...
09) At the UC, get new spells/abilities if you are a Mage, Priest, Rogue, Warlock or Warrior.  Warriors go NW to the War Quarter (47.16).  Train Whirlwind R1.  This is going to be your fury spender for the next few levels - weave it in between auto attacks.
