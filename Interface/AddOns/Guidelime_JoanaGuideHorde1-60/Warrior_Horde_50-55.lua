...
08) If you need to, get new spells/abilities.  Warriors, go to Hall of the Brave (80.32) and train Rend R6 and Recklessness at least.  Also accept "A Troubled Spirit [QA8417-]" from your trainer Sorek.
...
05) Do "Gammerita, Mon! [QC7816-]" (Elite): kill/loot Gammerita /target.  This lvl 48 Elite turtle patrols up and down the shore line.  Warriors, this quest is soloable, but its very tough.  The graveyard is close by so it doesn't hurt to try.
...
10) Follow the main path SW and from the Fallen Hero of the Horde (34.66) turn in "A Troubled Spirit [QT8417-]", accept "Warrior Kinship [QA8423-]".  Also accept "The Stones That Bind Us [QA2681-]".
...
Mob - Total Items Needed - After "Snickerfang Jowls [QT2581-]" - And then "The Decisive Striker [QT2585-]"
02) Vulture Gizzards     =14 - 14 - 12
03) Basilisk Brain         =11 - 11 - 11
04) Blasted Boar Lungs =6 - 4 - 3
05) Scorpok Pincers      =6 - 5 - 2
06) Snickerfang Jowls   =5 - 2 - 2
Warrior, 6a) Focus on these Warrior steps first:  Grind south and do "Warrior Kinship [QC8423-]": kill 7 Helboar (the purples dots on map only around the Dark Portal).

Warrior, 6b) Go north to the border of Blasted Lands and SoS, to the Fallen Hero of the Horde (34.66 in SoS) and turn in "Warrior Kinship [QT8423-]", accept "War on the Shadowsworn [QA8424-]".

Warrior, 6c) Go back south and on the eastern side of Blasted Lands do "War on the Shadowsworn [QC8424-]": kill the needed Shadowsworn mobs.  These mobs are found around the Servant of Allistarj on the map.  Keep the next step in mind:
...
02) Go to the border of Blasted Lands and SoS, to the Fallen Hero of the Horde (34.66 in SoS) and turn in (if you did it) "The Stones That Bind Us [QT2681-]", SKIP "Kirith".  Accept "Heroes of Old [QA2702-]".  Also turn in your warrior quest "War on the Shadowsworn [QT8424-]", SKIP "Voodoo Feathers" (Dungeon quest, although this can be done later as the rewards are very nice).
...
LET THE GRIND BEGIN:
01) Just south of Marshal's Refuge do "Super Sticky [QC4504-]": kill/loot the Tar mobs around the tar pits.  The Tar Lurkers have a nasty disease debuff for warriors.  But this debuff can be avoided by moving away from them once they start casting it.
