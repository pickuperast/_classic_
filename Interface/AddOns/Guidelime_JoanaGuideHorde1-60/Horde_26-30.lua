...
05) Go east to the Boiling Pool (35.35) and do "Sacred Fire [QC5062-]": loot the Incendia Agave from the ground and under the water.
...
05) Once at Orgrimmar, (if for some reason you are already level 30) go get new spells/abilities. 
...
01) Run all the way to Tarren Mill in Hillsbrad Foothills and get the FP there from the Bat Handler (60.19 in Hillsbrad).  You can just bypass the UC for now (no need to get UC's FP yet) and just follow the path shown on the map to get to Hillsbrad.  NOTES:  If you can, use a Swim Speed Potion to cross the lake.  Once you reach Alterac Mountains you can start grinding on some mobs along the way to Tarren Mill.  TIP:  Focus on killing some Snapjaw turtles along the shore and save the Turtle Meat for a later quest, I recommend obtaining at least 4 Turtle Meat before moving on (you can get more later on), and remember to not sell them to a vendor!
