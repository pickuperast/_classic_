...
[GA Hunter,Horde]
[NX46-50 Hunter,Horde]
Hunter, 1a) Hunters, as you enter the Badlands, go just SE a bit and see if Broken Tooth /target (lvl 37 rare cat) is available for taming.  This cat has several possible spawn locations, see map.  If he is, abandon your current main pet and tame this pet as your new main pet.  Broken Tooth is special because it has the fastest attack speed out of any pets in Classic WoW.  Faster attack speeds work great with the Frenzy talent.  If he is not there, don't worry, just move on and consider coming back later to grab him.
...
02) Make sure you are repaired/resupplied.  Hunters, make sure you have plenty of arrows/bullets as you cannot buy them in SoS.
...
06) Go SE to Stonard and in the Inn make it your new home from the Innkeeper (45.57).  Make sure you are repaired/resupplied.
07) Next to you in the Inn, accept "Lack of Surplus [QA698-]" and "Fresh Meat [QA1430-]".
Hunter, 7a) Hunters, just outside of the Inn (next to the mailbox), stable your pet at the Stable Master.

08) Go upstairs in the building and turn in "Report to Helgrum [QT1420-]" (48.55).  Next to you, accept "Pool of Tears [QA1420-]" (Elite).
Hunter, 8a) Hunters, go east and tame a DeathStrike Tarantula (around 56.61) for Bite R6.
Hunter, 8b) Continue east to the shore (around 85.83), then abandon your spider (make sure you get Bite R6 first), then tame a Silt Crawler /target for Claw R6.  Attack any mob in the area until you get it.
Hunter, 8c) Hearth to Stonard.
Hunter, 8d) Abandon your crab and get your cat back out from the Stable Master (next to the Inn entrance and mailbox) and teach him the new abilities.
...
15) Should be about lvl 42 now, if not that's okay.  Hunters, get new spells/abilities at the Hunter Trainer at Stonard (47.53).
...
01) GROUP 2+ Players:  Go north and do the last part of "Raptor Mastery [QC197-]" (Elite): kill/loot Tethis /target (lvl 43 Elite, he has 4 possible spawns, see map).  NOTE:  If you cannot find a group to do this now, you can try again later at level 47 STV section!  Hunters, this is possible to solo right now but its not easy.
...
07) GROUP 2+ Players (or this could be soloable):  Go north and do the last part of (if you still need to) "Panther Mastery [QC193-]" (Elite): kill/loot Bhag'thera /target.  This lvl 40 elite black panther has 3 different spawn points (see map).  If you cannot solo this now, you can try again later at level 47 STV section.  Hunters, this is possible to solo at lvl 42/43.
...
10) Turn in "Mok'thardin's Enchantment [QT573-]" (32.29).  Make sure you are repaired/resupplied.  Hunters, get new spells/abilities at the Hunter Trainer if you need to (31.29).
...
01) GROUP 2+ Players (or this could be soloable):  Go just SE of Grom'gol and do (if you have it) "Big Game Hunter [QC208-]" (Elite): kill/loot King Bangalash /target (lvl 43 Elite at 38.35).  NOTE:  If you cannot solo this now, you can try again later at level 47 STV section!  Hunters, this is possible to solo at lvl 42/43.
...
04) If you are level 44 and either a Druid, Hunter, Mage, Priest, Shaman or Warrior, then get new spells/abilities while in TB.  Hunters go just right next to you on The Hunter Rise (59.86).
...
11) Go NW to the Mannoroc Coven and do "The Corrupter [QC1488-]" (Elite): kill Lord Azrethoc /target (lvl 40 elite doomguard that patrols around) and also kill Jugkar Grim'rod /target (lvl 40 orc warlock, at 56.78).
...
03) From the male troll under the green tent, accept "Screecher Spirits [QA3520-]" (67.22).  Hunters, it is important to note that you cannot buy arrows at Gadgetzan, but you can get them at Steamwheedle Port from Jabbey in the hut (67.22).
...
07) Do "Southsea Shakedown [QC8366-]" along with "Pirate Hats Ahoy! [QC8365-]": kill/loot the Southsea humans (the Southsea Dock Workers are up at 75.48).  Any of these mobs has a chance to drop a Pirate's footlocker, which could contain an item which starts "Ship Schedules [QA2876-]", accept it if you are able to find it, if not at least grind for awhile as it might show up, otherwise it can be skipped.  Also do the following 2 steps below in this same area:
08) "Stoley's Shipment [QC2873-]": loot the Stolen Cargo up in the building (72.47).
09) "WANTED: Andre Firebeard [QC2875-]": kill/loot Andre Firebeard /target in the middle of the cove (73.47).  Watch out this fight usually involves 3 adds.  (See Video).
...
09) Go to the Wind Rider Master (north of Gadgetzan, 52.25) and fly to Freewind Post, Thousand Needles.  Hunters, you will not be able to buy any meat in Feralas coming up.  So if your pet needs meat you can get that from Freewind Post first.
...
06) If you need to, get new spells/abilities.  Hunters, go to (66.19).  But if you are all caught up on getting new skills, the only good PvE skill available for lvl 46 is Immolation Trap R4, so if you are in a hurry I recommend just skipping that for now.
