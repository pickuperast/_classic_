...
04) Once done, go back to the church (31.66, #2 on map) and turn in "The Mindless Ones [QT364-]".  Accept "Simple Scroll [QA3095-]" and "Rattling the Rattlecages [QA3901-]".  Next to you accept "The Damned [QA376-]".
05) Go across the road and in the bigger house, from the Warrior Trainer (33.66), turn in "Simple Scroll [QT3095-]". Also get new spells/abilities.
...
07) Go back to the church and turn in "Rattling the Rattlecages [QT3901-]" (31.66, #2 on map).  Next to you, turn in "The Damned [QT376-]".  Accept "Marla's Last Wish [QA6395-]". 
08) Right outside the church (32.66), accept "Night Web's Hollow [QA380-]" and "Scavenging Deathknell [QA3902-]".  In the bigger house next to you, from the Warrior Trainer (33.66), get your level 4 spells/abilities.
...
09) In Brill's Inn, get your level 6 spells/abilities.  The Warrior Trainer is next to you at the sitting area.
...
03) Go in the Town Hall and turn in "Graverobbers [QT358-]".  Accept "Forsaken Duties [QA359-]" (61.51).
...
09) Make sure you are repaired/resupplied.  Also get your level 8 spells/abilities.  The Warrior Trainer is next to you at the sitting area.
...
14) If you finished "The Chill of Death [QC375-]", go to the Trade Supplies vendor (under the red tent 61.52) and purchase a Coarse Thread, then go upstairs in the Inn and turn in "The Chill of Death [QT375-]" (but it doesn't need to be completed now).  Then, if you are level 10 (if not don't worry) go to the Warrior Trainer in the Inn at the sitting area and accept "Speak with Deathguard Dillinger [QA1818-]" (# 4 on map), and get your level 10 spells/abilities too.
15) Go downstairs in the Inn and turn in "Fields of Grief [QT407-]" (62.51).
16) Go SW to the Scarlet tower and do "At War with the Scarlet Crusade [QC427-]": kill the needed mobs and Captain Perrine is in the watchtower (51.68).  NOTE:  "Proof of Demise" does not need to be completed now.

10-12 Tirisfal Glades
01) Go back NE to Brill and In front of the Town Hall, turn in "At War with the Scarlet Crusade [QT427-]" (61.52), accept the next part [QA371-].  Also turn in next to you (if it is done) "Proof of Demise [QT374-]".  Make sure you are repaired/resupplied.
Warrior, 1a) Make sure you are level 10 (grind on any mobs around Brill until you are), then if you haven't yet, go in Brill's Inn and from the Warrior Trainer (62.52) at the sitting area accept your level 10 quest "Speak with Deathguard Dillinger [QA1818-]" (62.53) along with getting your level 10 spells/abilities.
...
Warrior, 1a) In front of the graveyard entrance, turn in "Speak with Deathguard Dillinger [QT1818-]" (58.51), accept "Ulag the Cleaver [QA1819-]".
Warrior, 1b) Go north in the graveyard to the crypt and do "Ulag the Cleaver [QC1819-]": open the Doors to the crypt (60.48) and then defeat Ulag the Cleaver.  Be careful this mob is level 11 and hits hard.
Warrior, 1c) Back south in front of the graveyard entrance, turn in "Ulag the Cleaver [QT1819-]" (58.51), accept "Speak with Coleman [QA1820-]".
Warrior, 1d) Go in the Inn and turn in "Speak with Coleman [QT1820-]", accept "Agamand Heirlooms [QA1821-]".

02) Above Agamand Mills, go down in the crypt (entrance at 52.26) and do "The Family Crypt [QC408-]" along with your class quest "Agamand Heirlooms [QC1821-]": kill the zombies and ghosts, and kill/loot Captain Dargol, he is at the very bottom of the crypt.  And loot the 4 Agamand Weapon Racks throughout the crypt.  You need to loot each individual one, locations are:  1) First room on the right.  2) Down the steps next to you and then on the left.  3) Across to the other room next to you.  4) Very bottom of the crypt on the left.  NOTE:  This quest is not easy, but every class should be able to solo it at level 11 with good skill.
...
04) Go in the Inn and turn in "Agamand Heirlooms [QT1821-]" (62.52).  Then complete "Heirloom Weapon [QT1822-]".  Then Go in the basement of the Inn and turn in "A New Plague [QT492-]".  Make sure you are repaired/resupplied.
...
09) Make sure you are level 12, grind on any mobs around Brill until you are.  Then go in Brill's Inn and get your level 12 spells/abilities.  The Warrior Trainer is at the sitting area.
...
10) Leave Orgrimmar (south) and run to Razor Hill (in Durotar) to get new spells/abilities.  You can also upgrade First Aid if you need to in the Barracks from the First Aid Trainer (54.42).  You can find the Warrior Trainer (54.43) in the Barracks.
