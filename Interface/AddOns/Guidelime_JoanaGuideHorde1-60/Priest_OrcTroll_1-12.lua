...
06) Make sure "Cutting Teeth [QC788-]" is complete, then go to The Den entrance and turn in "Cutting Teeth [QT788-]" and "Sarkoth [QT804-]" (42.68, #2 on map), accept "Sting of the Scorpid [QA789-]" and "Hallowed Tablet [QA3085-]" .
07) Just outside of the cave on the brown rug, from the Priest Trainer (42.69) turn in "Hallowed Tablet [QT3085-]" .  Also get new spells/abilities from your class trainer.
...
14) Outside by the wagon, turn in "Vile Familiars [QT792-]" (43.69, #8 on map), accept "Burning Blade Medallion [QA794-]".  Also make sure you get new spells/abilities. The Priest Trainer (is at 42.69 on the brown rug).
...
Priest, 17a) On the brown rug, from the Priest Trainer (42.69), accept "In Favor of Spirituality [QA5649-]".
...
Priest, 8a) Next to you in the Barracks, from the Priest Trainer (54.43), turn in "In Favor of Spirituality [QT5649-]", accept "Garments of Spirituality [QA5648-]".  Also get new/spells abilities.
Priest, 8b) Go south of Razor Hill and on the east side of the main path next to a tall rock do "Garments of Spirituality [QC5648-]": heal the kneeling Grunt Kor'ja (53.46, /target) with Lesser Heal R2, and buff her with Fortitude.
...
Priest, 14a) Go in the Barracks and from the Priest Trainer (54.43), turn in "Garments of Spirituality [QT5648-]".  Also get new/spells abilities.
...
Priest, 17a) Go in the Barracks and from the Priest Trainer (54.43) accept "Hex of Weakness [QA5655-]".  Also get new spells/abilities.
...
Orgrimmar
Priest, 1a) Stay up (cross the bridge), go SW to the Valley of Spirits and at the Priest Trainer (36.88 in Orgrimmar) turn in "Hex of Weakness [QT5655-]" (66.18).
...
07) Hearth to Razor Hill.  Make sure you are level 12 (grind on any mobs until you are).  Make sure you get repaired/resupplied.  Upgrade First Aid in the Barracks from Rawrk to learn Heavy Linen Bandage.  Go in the Barracks and from the Priest Trainer (54.43), get new/spells abilities. 
