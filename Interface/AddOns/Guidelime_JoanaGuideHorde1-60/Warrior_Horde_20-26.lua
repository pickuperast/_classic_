...
06) GROUP 2+ Players:  West in Sishir Canyon do "Arachnophobia [QC6284-]" (Elite): kill/loot Besseleth (lvl 21 elite orange spider, with several possible spawn locations, around 52.74,  /target ).  NOTE:  Besseleth can be soloed later in the guide at level 24 by all classes.
...
01) Run to Sun Rock Retreat and at the tauren next to the Inn turn in "Arachnophobia [QT6284-]" (47.61).
...
05) Go SE to Boulderslide Cavern (entrance at 61.93) and do "Boulderslide Ravine [QC6421-]": loot the Resonite Crystals in the cave and go far back into the cave towards the water for the Investigation.  Be careful in here even if you're a higher level.  Mob density is high and you can easily overpull.  Used ranged pulls and reset mobs if you get too much.  Grouping is encouraged.
...
03) The goal now is to go all the way to the other side of Ashenvale, to Zoram Strand.  Once you get to Astranaar (alliance town, #3 on map), go south of it to get around it, grind mobs along the way.
...
07) You can get resupplied from the Fish Merchant & Supplies at the Outpost.
...
06) If you have Blood Shards, give them to the quilboar in the cage (45.59).  For Warriors, get strength, agility and Razorhide buffs.
...
08) Go south and do "Egg Hunt [QC868-]": loot the Silithid Mounds.  This quest is very difficult for a Warrior.  Be careful not to pull more than one mob at a time, these guys do a ton of damage.  Hamstring method does wonders here.  The Swarmers will spawn low-heatlh adds periodically.  Pool your rage and use Thunder Clap or Cleave to take them out quickly.   NOTE:  There is an elite mob called Silithid Harvester (at 43.70 or 48.69, /target) that drops an item which starts "The Harvester [QA897-]", accept it if you are able to kill this mob.  This elite has a 2 hour 45 min respawn, so he may not be there.  You can try again later at the level 25 Southern Barrens section below.
...
07) North at CT by the Forge, turn in "Weapons of Choice [QT893-]" (45.58).  Orc Warrior ONLY:  Do not equip the 2h Mace reward!  It's actually a DPS loss simply because of your Axe expertise racial.  Stick with your Zhovur Axe (if you are still using it).
...
06) Work your way north while killing deer & saps for "Jin'Zil's Forest Magic [QC1058-]".  Once you get to Stonetalon Peak (36.13) do "Cenarius' Legacy [QC1087-]": kill the Cenarion night elf mobs around the middle of Stonetalon Peak.  This quest is incredibly annoying as a Warrior.  Killing the Sons and their Treant Allies are the worst because they leash together.  Group up if you can.  If you can't, just burn down the Sons using long cooldowns (racial, Intimidating Shout, and Retaliation) and their Treant will disappear.  You do not want to die up here - the corpse run is very long.  Keep the next step in mind:
...
10) Go to the Wind Rider Master (45.60) and fly to Thunder Bluff, Mulgore.
...
02) Just east a bit by the Bonfire, accept "The sacred Flame [QA1195-]" (55.51).
03) Turn in (if you haven't yet) "Melor Sends Word [QT874-]" (on The Hunter Rise, 62.81), accept "Steelsnap [QA1131-]".
04) Get new spells/abilities for your class.  Warrior Trainers are at The Hunter Rise, (59.87 in TB). Recommended abilities at this level are:  Execute and Heroic Strike R4.
...
Warrior, 3a) Each time you visit Freewind Post, check the Lorekeeper vendor Montarr (45.51) for Liferoot.  You will eventually need to collect 8 of them for the Whirlwind Axe questline in the early 30s.  You can also check the AH for this item too.

04) From the Wanted Poster - Arnak Grimtotem next to the Inn, accept "Wanted - Arnak Grimtotem [QA5147-]" (46.51).  Make sure you are repaired/resupplied.
...
08) Go to the Wind Rider Master at CT (44.59) and fly to Splintertree Post, Ashenvale.  While flying, keep the next step in mind:
09) If you still need to upgrade to Heavy Wool Bandage (requires First Aid skill 115), then as you are flying click on the Request Stop button (to stop at Orgrimmar), then go SW to The Valley of Spirits and get that at the First Aid Trainer (34.85 in Orgrimmar).  You don't necessarily need to learn Silk Bandage yet, as you can save your Silk Cloth until you get the book to advance to Expert First Aid later.  Then hop back on the Flight to Splintertree Post, Ashenvale.	
]], "Dreamcast1991")