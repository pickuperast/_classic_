...
04) Once done, go back to the church (31.66, #2 on map) and turn in "The Mindless Ones [QT364-]".  Accept "Encrypted Scroll [QA3096-]" and "Rattling the Rattlecages [QA3901-]".  Next to you accept "The Damned [QA376-]".
05) Go across the road and in the bigger house, from the Rogue Trainer (32.66), turn in "Encrypted Scroll [QT3096-]". Also get new spells/abilities.
...
08) Right outside the church (32.66), accept "Night Web's Hollow [QA380-]" and "Scavenging Deathknell [QA3902-]".  In the bigger house next to you, from the Rogue Trainer (32.66), get your level 4 spells/abilities.
...
09) In Brill's Inn, get your level 6 spells/abilities.  The Rogue Trainer is upstairs.
...
09) Make sure you are repaired/resupplied.  Also get your level 8 spells/abilities.  The Rogue Trainer is upstairs in the Inn.
...
01) Go upstairs in Brill's Inn and from the Rogue Trainer, accept "Mennet Carkad [QA1885-]" (62.52).  Also learn your level 10 spells/abilities.
02) Then go down into the Under City (UC). (entrance at 63.74 in Tirisfal Glades)
03) Once in the UC, go SE to The Rogues' Quarter and turn in "Mennet Carkad [QT1885-]" (83.69), accept "The Deathstalkers [QA1886-]".
04) Go north to the Magic Quarter, turn in "The Prodigal Lich [QT405-]" (up at 84.17), SKIP "The Lich's Identity".
05) While in the UC, you can learn new weapon possibilities at the Weapons Master (57.33), if you can afford to do so.  Getting One-Handed Swords is very useful for Rogues.
06) Exit the UC through the sewer (entrance west in UC, 46.44).
07) As you exit the sewer, go down to the tower and do "At War with the Scarlet Crusade [QC427-]": kill the needed mobs and Captain Perrine is in the watchtower (51.68 in Tirisfal Glades).  NOTE:  "Proof of Demise" does not need to be completed now.
08) Do "The Deathstalkers [QC1886-]".  This quest has you find a friendly NPC named Astor Hadren, this level 13 undead patrols from the front outside of the Undercity (around 62.62 in Tirisfal Glades) all the way south on the main path into Silverpine Forest's Horde town The Sepulcher (46.40 in Silverpine Forest).  Once you find him, talk to him, then defeat him and loot Astor's Letter of Introduction.
09) Enter The Undercity, then go SE to The Rogues' Quarter and turn in "The Deathstalkers [QT1886-]" (83.69, #3 on map), accept the next part [QA1898-].
10) Go west to The Apothecarium and turn in "The Deathstalkers [QT1898-]" (55.76), accept the next part [QA1899-].
11) Next to you do "The Deathstalkers [QC1898-]": loot Andron's Bookshelf behind Andron Gant.
12) Go back east to The Rogues' Quarter and turn in "The Deathstalkers [QT1898-]" (83.69, #3 on map), accept the next part [QA1978-].
13) Go west to a specific entrance at The Apothecarium (at 51.66).
14) Follow the tunnel to the end and from Varimathras (56.92), turn in "The Deathstalkers [QT1978-]".
15) Hearth or go back to Brill.
...
09) Make sure you are level 12, grind on any mobs around Brill until you are.  Then go in Brill's Inn and get your level 12 spells/abilities.  The Rogue Trainer is upstairs in the Inn.
...
10) Leave Orgrimmar (south) and run to Razor Hill (in Durotar) to get new spells/abilities.  You can also upgrade First Aid if you need to in the Barracks from the First Aid Trainer (54.42).  You can find the Rogue Trainer at the top of the burrow.
