...
06) Make sure "Cutting Teeth [QC788-]" is complete, then go to The Den entrance and turn in "Cutting Teeth [QT788-]" and "Sarkoth [QT804-]" (42.68, #2 on map), accept "Sting of the Scorpid [QA789-]" and "Etched Tablet/Parchment [QA3082-]" .
07) Outside next to the wagon/tent, from the Hunter Trainer (43.69) turn in "Etched Tablet/Parchment [QT3082-]" .  Also get new spells/abilities from your class trainer.
...
14) Outside by the wagon, turn in "Vile Familiars [QT792-]" (43.69, #8 on map), accept "Burning Blade Medallion [QA794-]".  Also make sure you get new spells/abilities. The Hunter Trainer is right next to you on the rug (43.69).
...
14) If you're not at least 3 bars away from lvl 8, grind until you are (for lvl 8 spells/abilities), Then go to Razor Hill and at the top of the burrow turn in "From The Wreckage.... [QT825-]" (52.44, #4 on map).    Also get new spells/abilities from the Hunter Trainer in the bottom of the burrow.  Also make sure you are repaired/resupplied.
...
01) At the bottom of the burrow, accept "Taming the Beast [QA6062-]" (52.44).  Also get new spells/abilities.  Then do "Taming the Beast [QC6062-]" by using your Taming Rod quest item to tame the following beasts:
02) Tame a Dire Mottled Boar (just SW of Razor Hill, around 52.46).
03) Run back and turn in "Taming the Beast [QT6062-]" (52.44, # 1 on map) and accept the next part [QA6083-].
04) At the Bowyer (53.41) under the red tent, upgrade to Sharp Arrows and a Medium Quiver.
05) Tame a Surf Crawler NE of Razor Hill along the beach (around 59.28).
06) Run back and turn in "Taming the Beast [QT6083-]" (52.44, # 1 on map) and accept the next part [QA6082-].
07) Tame a Armored Scorpid NW of Razor Hill (around the watchtower 49.37).
08) Run back and turn in "Taming the Beast [QT6082-]" (52.44, # 1 on map), accept "Training the Beast [QA6081-]".
09) On the west side in Razor Hill, accept "Conscript of the Horde [QA840-]" (51.44).
10) Go west (around 36.47) and tame a Venomtail Scorpid /target for your first real pet.  Try to get a level 10.  This allows you to learn Claw R2 and Scorpid Poison.
...
Orgrimmar
01) Stay up (cross the bridge), then Go north to Thrall and accept "Hidden Enemies [QA5726-]" (32.38).  Next to you, turn in "The Admiral's Orders [QT831-]".
Hunter, 1a) Go east to the Hunter Trainer and turn in "Training the Beast [QT6081-]" (66.18 in Orgrimmar).
Hunter, 1b) If you can afford to, you can learn new weapon possibilities at the two Weapon Masters in the hut (east of you at 82.19).  I recommend eventually learning Two-Handed Axes and/or Staves from them.
...
07) Hearth to Razor Hill.  Make sure you are level 12 (grind on any mobs until you are).  Make sure you get repaired/resupplied.  Upgrade First Aid in the Barracks from Rawrk to learn Heavy Linen Bandage.  Also get new spells/abilities from the Hunter Trainer in the bottom of the burrow. 
...
03) go up the big mountain ramp (begins at 51.22).
