...
Warlock, 2a) In the middle of the village, turn in "News of Dogran [QT1510-]" (73.95), accept "Ken'zigla's Draught [QA1511-]".
...
Warlock, 5a) By the crates, turn in "Ken'zigla's Draught [QT1511-]" (45.59), accept "Dogran's Captivity [QA1515-]".
06) If you have Blood Shards, give them to the quilboar in the cage (45.59).  If you can, get Spirit of the Wind (for faster movement).
Warlock, 6a) Go north a bit to the quilboar camps and in a hut turn in "Dogran's Captivity [QT1515-]", accept "Love's Gift [QA1512-]".
...
04) Get new spells/abilities for your class.  Warlocks ignore this!
05) Go up to the Wind Rider Master in the middle of TB (47.50) and fly to Orgrimmar, Durotar.
Warlock, 5a) Once at Orgrimmar, go to the Cleft of Shadow (48.45) and learn your lvl 24 spells/abilities.  Also turn in "Love's Gift [QT1512-]", accept "The Binding [QA1513-]".
Warlock, 5b) Just south a bit in Cleft of Shadow go in the tent with the purple summoning symbol on the ground (49.50) and do "The Binding [QC1513-]": use Dogran's Pendant in the tent then kill the succubus that spawns.
Warlock, 5c) Go back north a bit in Cleft of Shadow and turn in "The Binding [QT1513-]" (48.45).  You can now summon a succubus and gain a Small Soul Pouch.  NOTE:  The Voidwalker will still be your primary minion for speed leveling to 60, but the Succubus minion can be useful against lower lvl green mobs, or certain situations.
Warlock, 5d) Go up to the Wind Rider Master (45.64) and fly to Camp Taurajo, The Barrens.
...
08) Go to the Wind Rider Master at CT (44.59) and fly to Orgrimmar, Durotar.
Warlock, 8a) Once at Orgrimmar, go to the Cleft of Shadow (48.45) and learn your lvl 26 spells/abilities.
Warlock, 8b) If you still need to upgrade to Heavy Wool Bandage (requires First Aid skill 115), then go SW to The Valley of Spirits and get that at the First Aid Trainer (34.85).  You don't necessarily need to learn Silk Bandage yet, as you can save your Silk Cloth until you get the book to advance to Expert First Aid later.
Warlock, 8c) Go up to the Wind Rider Master (45.64) and fly to Splintertree Post, Ashenvale.
]], "Dreamcast1991")