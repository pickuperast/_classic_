...
Mob - Total Items Needed - After "A Boar's Vitality [QT2583-]" - And then "The Basilisk's Bite [QT2601-]"
02) Vulture Gizzards     =14 - 14 - 12
03) Basilisk Brain         =11 - 10 - 0
04) Blasted Boar Lungs =6 - 3 - 3
05) Scorpok Pincers      =6 - 4 - 4
06) Snickerfang Jowls   =5 - 5 - 5
...
08) Get new spells/abilities at your class trainer.  Warlocks, ignore this!
...
13) Once at BB, go up in the Inn to the roof at the Wind Rider Master (27.77) and fly to Stonard, Swamp of Sorrows.
Warlock, 13a) At Stonard, go up in the building and get new spells/abilities from the Warlock Trainer (49.56).  Also accept "An Imp's Request [QA8419-]".  NOTE: This quest requires a Felcloth, which can be found in the AH or farmed from satyrs in Felwood later on.
Warlock, 13b) At Stonard, go to the Wind Rider Master (46.55) and fly to Kargath, Badlands.
...
02) Once at Orgrimmar, go to the Bank (49.69) and get the following items out:  8 White Ravasaur Claws, Tinkee's Letter and Linken's Training Sword.  Also get out 60 Runecloth for cloth donation to the Orc faction.  And get out (if you have it) one Felcloth (and remember to not sell it).
...
06) If you need to, get new spells/abilities.  If you haven't got your lvl 54 spells yet do so now in Cleft of Shadows (48.46).  Make sure you are repaired/resupplied.
...
Warlock, 4a) Go north just above Bloodvenom Falls and (if you have a Felcloth) turn in "An Imp's Request [QT8419-]" (41.45), accept "The Wrong Stuff [QA8421-]".  Also next to you accept "What Niby Commands [QA7601-]" (41.45).  Then next to you turn in "What Niby Commands [QT7601-]", SKIP "Flawless Fel Essence" (for now).  This is the questline to obtain the Infernal minion.  This quest does not fit into the route for speedleveling but you may want to do this later, especially after hitting 60.
05) In the immediate area, start working on "A Sample of Slime... [QC4293-]": kill/loot Tainted Oozes for getting at least 35 Felwood Slime Samples eventually.  You don't need to get all of them now.  Also do part of "The Wrong Stuff [QC8421-]": kill/loot Tainted Oozes for the 4 Bloodvenom Essence.
...
02) Follow the main path NE to Irontree Woods and do "Cleansing Felwood [QC4102-]": kill/loot the Warpwood elementals.  There is more mobs in the Irontree Cavern (entrance at 56.17).  Also around the green lake (49.24) do the last part of "The Wrong Stuff [QC8421-]": kill/loot the tree mobs for the 10 Rotting Wood.
